...
<html lang="en">
    <head>
        ...
        <script>
            tailwind.config = {
                ...
                <title>Haddis Jobs | Find Jobs & Projects</title>
    ...
    <body>
        ...
        >
           <p class="ml-2">Copyright &copy; 2025 Haddis Tech, All Rights reserved</p>

           <a
              href="/listings/create"
              class="absolute top-1/3 right-10 bg-black rounded-lg text-white py-2 px-5"
            >
               Post Job
           </a>
        </footer>
